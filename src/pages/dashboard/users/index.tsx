...
import { UserListTable } from 'src/components/dashboard/users/user-list-table';

const applyFilters = (
  users: APIUser[],
  filters: Filters
): APIUser[] => users.filter((user) => {
  if (filters.name) {
...
const applyPagination = (
  ...
  page: number,
  rowsPerPage: number
): APIUser[] => users.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage);
