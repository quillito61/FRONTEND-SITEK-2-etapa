      ...
      >
        ...
        >
          ...
          <Box sx={{ flexGrow: 1, flexDirection: 'row' }}>
            ...
            >
              {/* AQUI VAN LOS LOGOS HORIZONTALES */}
            
             <Box sx={{display:{ xs: 'none', lg: 'inline-flex'}}}>
             <img src='/static/bm.jpeg' />
             {/* <img  src='/static/Logo_Peri.png' />
             <img  src='/static/Logo_Saretto.png' />
              <img src='/static/Logo_Saretto_Selecto.png' />
              <img src='/static/Logo_Super-Viquez.png' />
              <img src='/static/Logo_SuperCompro.png' /> */}
             </Box>
